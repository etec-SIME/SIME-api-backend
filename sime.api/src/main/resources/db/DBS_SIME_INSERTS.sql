...
('Manuten��o', 'Respons�vel por reparos f�sicos');
...
('Laborat�rio com 20 computadores', 'Lab de Inform�tica'),
...
(GETDATE(), 'Resolvido rapidamente, obrigado!', 'T�cnico', 'Funcion�rio', 1, '345678');
